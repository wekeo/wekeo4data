...
**wekeo-xcube** is a collection of Python-based code 
designed to provide an introduction and examples on the use 
of the the [xcube](https://xcube.readthedocs.io/en/latest/) Python package and the [xcube Viewer](https://github.com/xcube-dev/xcube-viewer) for WEkEO and Copernicus data.
